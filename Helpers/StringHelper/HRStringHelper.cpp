                                    ...
                                    time_t timestamp /* = -1   */)
{
    ...
    std::string m = HRStringHelper::intToString(time->tm_mon + 1);          // 月 2桁 *****
    ...
    std::string d = HRStringHelper::intToString(time->tm_mday);             // 日 2桁 *****
    ...
    std::string H = HRStringHelper::intToString(time->tm_hour);             // 時 24時間表記 2桁 *****
    std::string G = HRStringHelper::intToString(time->tm_hour);             // 時 24時間表記
    std::string h = HRStringHelper::intToString((time->tm_hour <= 12) ? time->tm_hour : time->tm_hour-12);  // 時 12時間表記 2桁 *****
    std::string g = HRStringHelper::intToString((time->tm_hour <= 12) ? time->tm_hour : time->tm_hour-12);  // 時 12時間表記
    std::string i = HRStringHelper::intToString(time->tm_min);              // 分 2桁 *****
    std::string s = HRStringHelper::intToString(time->tm_sec);              // 秒 2桁 *****
